...
export default function AquariumDetail({ tank, onEdit, onDelete }: Props) {
  ...
  return (
    <div className="px-6 pt-5 pb-10">
      ...
      {/* Hero */}
      <div className={cn('relative h-64 rounded-2xl overflow-hidden mb-6 bg-gradient-to-br', hero.from, hero.via, hero.to)}>
        {/* Decorative circles */}
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="p-2 rounded-lg bg-sky-500/20 hover:bg-sky-500/40 transition-colors"
                title={t('publish.buttonTitle')}
              >
