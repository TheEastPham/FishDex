...
import { 
  ...
  Shield, Home, Settings, FileText, ImageIcon, User
} from 'lucide-react';
...
export default function AppShell() {
  ...
  const DEFAULT_AVATARS = [
    'https://api.dicebear.com/7.x/bottts/svg?seed=Felix&backgroundColor=0284c7', // Bot
    'https://api.dicebear.com/7.x/fun-emoji/svg?seed=Mimi&backgroundColor=059669', // Emoji
    'https://api.dicebear.com/7.x/avataaars/svg?seed=Aneka&backgroundColor=c026d3', // Person
    'https://api.dicebear.com/7.x/pixel-art/svg?seed=Bella&backgroundColor=ea580c', // Pixel
    'https://api.dicebear.com/7.x/shapes/svg?seed=Coco&backgroundColor=4f46e5', // Shapes
  ];
  ...
  const navItems: NavItem[] = [
    ...
    {
      icon: Settings, // Or some other icon for Utilities
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col items-start">
                <span className="text-sm font-bold text-white truncate max-w-[120px]">Fish Lover</span>
                <span className="text-xs text-slate-400 font-medium truncate max-w-[120px]">Admin</span>
              </div>
            </div>
